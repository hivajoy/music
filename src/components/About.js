...
function About(props) {
    ...
    useEffect(() => {
        ...
        document.title = "About - Hivajoy Music"
    }, [])
            ...
            <section className="text-gray-700 dark:text-gray-400 body-font bg-light-100 dark:bg-deep-900">
                <div className="container px-5 pt-28 pb-10 mx-auto">
                    <div className="flex flex-col text-center w-full mb-20">
                        ...
                        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-black dark:text-white">Hivajoy Music</h1>
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">With Hivajoy Music, you can listen and download over 80 million songs (number of songs available on JioSaavn) for FREE without any ads!</p>
                    </div>
                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="xl:w-1/3 md:w-1/2 p-4">
                            <div className="border hover:bg-light-200 dark:hover:bg-gray-900 md:h-40 h-auto border-gray-700 border-opacity-75 p-6 rounded-lg">
                                ...
                                <p className="leading-relaxed text-base">Hivajoy Music allows you to easily download your favorite songs, albums, or playlists so that you can listen to them offline.</p>
                            </div>
                        </div>
                        <div className="xl:w-1/3 md:w-1/2 p-4">
                            <div className="border hover:bg-light-200 dark:hover:bg-gray-900 md:h-40 h-auto border-gray-700 border-opacity-75 p-6 rounded-lg">
                                ...
                                <p className="leading-relaxed text-base">Hivajoy Music allows use to listen your favourite songs at the highest quality (320kbps!).</p>
                            </div>
                        </div>
                        <div className="xl:w-1/3 md:w-1/2 p-4">
                            <div className="border hover:bg-light-200 dark:hover:bg-gray-900 md:h-40 h-auto border-gray-700 border-opacity-75 p-6 rounded-lg">
                                ...
                                <p className="leading-relaxed text-base">Hivajoy Music is constantly updated with the latest music, thanks to JioSaavn.</p>
                            </div>
                        </div>
                        <div className="xl:w-1/3 md:w-1/2 p-4">
                            <div className="border hover:bg-light-200 dark:hover:bg-gray-900 md:h-40 h-auto border-gray-700 border-opacity-75 p-6 rounded-lg">
                                ...
                                <p className="leading-relaxed text-base">With Hivajoy Music's intuitive search functionality, you can quickly and easily find your favorite songs, albums, and playlists,</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2">
                        ...
                        <div className="p-2 sm:w-1/2 w-full">
                            <div className="bg-sky-600 hover:bg-sky-800 rounded flex p-4 h-full items-center">
                                ...
                                <a href="https://shivamnox.rf.gd" target="_blank" rel="noopener noreferrer" className="flex justify-center w-full title-font font-medium text-white">TailwindCSS</a>
                            </div>
                        </div>
                        <div className="p-2 sm:w-1/2 w-full">
                            <div className="bg-green-800 hover:bg-green-900 rounded flex p-4 h-full items-center">

                                <a href="https://shivamnox.rf.gd" target="_blank" rel="noopener noreferrer" className="flex justify-center w-full title-font font-medium  text-white">ShivamNox's Unofficial JioSaavn API</a>
                            </div>
                        </div>
                        <div className="p-2 sm:w-1/2 w-full">
                            <div className="bg-gray-800 hover:bg-gray-900 rounded flex p-4 h-full items-center">

                                <a href="https://shivamnox.rf.gd" target="_blank" rel="noopener noreferrer" className="flex justify-center w-full title-font font-medium text-white">Hosted on Vercel</a>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2">
                        <div className="p-2 sm:w-1/2 w-full">
                            <div className="bg-pink-700 hover:bg-pink-900 rounded flex p-4 h-full items-center">
                                ...
                                <a href="https://github.com/shivamnox/" target="_blank" rel="noopener noreferrer" className="flex justify-center w-full title-font font-medium text-white">My Github Profile</a>
                            </div>
                        </div>
                        <div className="p-2 sm:w-1/2 w-full">
                            <div className="bg-violet-700 hover:bg-violet-900 rounded flex p-4 h-full items-center">

                                <a href="https://shivamnox.rf.gd" target="_blank" rel="noopener noreferrer" className="flex justify-center w-full title-font font-medium text-white">My Other Projects</a>
                            </div>
                        </div>
                        <div className="p-2  w-full">
                            <div className="bg-yellow-700 hover:bg-yellow-900 rounded flex p-4 h-full items-center">

                                <a href="https://shivamnox.rf.gd" target="_blank" rel="noopener noreferrer" className="flex justify-center w-full title-font font-medium  text-white">Hivajoy Music's Git Repository</a>
                            </div>
                        </div>
